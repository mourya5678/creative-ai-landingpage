        ...
        <div className="ct_middle_navbar">
          <nav>
            <ul className={`mb-0 ${isMenuOpen ? "show" : ""}`}>
                  ...
                  {/* <div className="ct_dropdown_items">
                    ...
                    <ol className="ct_ps_35">
                      <li>
                        ...
                        <Link href="/entrepreneurs" onClick={() => setIsMenuOpen(false)}>
                          <p className="mb-0">
                      ...
                      <li>
                        ...
                        <Link href="/smbs" onClick={() => setIsMenuOpen(false)}>
                          <p className="mb-0">
                      ...
                      <li>
                        ...
                        <Link href="/enterprise" onClick={() => setIsMenuOpen(false)}>
                          <p className="mb-0">
              ...
              <li className="ct_dropdown">
                <span type="button">Resources<i className="fa-solid fa-chevron-down ms-1"></i></span>
                      ...
                      <li>
                        <div className="ct_grid_2_flex">
                          ...
                          <div>
                            ...
                            <Link href="/our-projects" onClick={() => setIsMenuOpen(false)}>
