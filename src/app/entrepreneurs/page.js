         ...
         <section className="ct_py_70 ct_md_py_50">
            <div className="container">
               ...
               <div className="row align-items-center ct_py_70 ct_mb_py_0 mb-lg-0 mb-5  ct_row_reverse_767">
                  <div className="col-md-7  mb-md-0 aos-init aos-animate" data-aos="fade-right">
                     <div className="ct_flexible_serivce_cnt">
                  ...
                  <div className="col-md-4  mb-md-0 offset-md-1 aos-init aos-animate" data-aos="fade-left">
                     <div className="ct_creative_single_img mb-5">
