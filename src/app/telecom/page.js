    ...
    <>
              ...
              <div className="col-lg-6 mb-4 mb-lg-0">
                <div className="ct_hero_banner_left_cnt">
                  ...
                  <div className="ct_btn_group mt-5">
                    <a className="ct_blue_btn_fill" href={LOGIN_URL}>Start Today</a>
                  </div>
                </div>
              </div>
              <div className="col-lg-6 mb-4 mb-lg-0">
                <div className="ct_hero_right_main">
                  <div className="position-relative">
                    <img alt="AI app builder" className="ct_img_w_80 ct_img_h_400" src="/img/telecom_main_banner_new.webp" style={{ objectFit: "contain" }} />
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="ct_pt_50 ct_pb_50">
        <div className="container">
          ...
          <div className="row align-items-center pt-5">
            <div className="col-md-4 mb-5 mb-md-0 aos-init aos-animate">
              <div className="ct_creative_single_img">
                <img alt="AI app builder" loading="lazy" src="/img/telecome_img_new_1.webp" />
              </div>
            </div>
          ...
          <div className="row align-items-center ct_py_70 pb-0">
            <div className="col-md-4 mb-5 mb-md-0 aos-init aos-animate">
              <div className="ct_creative_single_img">
                <img alt="AI app builder" className="ct_object_cover ct_border_radius_10" loading="lazy" src="/img/telecome_img_new_3.webp" />
              </div>
            </div>
            <div className="col-md-7 mb-5 mb-md-0 aos-init aos-animate offset-md-1">
              <div className="ct_flexible_serivce_cnt">
          ...
          <div className="row align-items-center ct_py_70 pb-0 ct_row_reverse_767">
            ...
            <div className="col-md-4 mb-5 mb-md-0 offset-md-1 aos-init aos-animate">
              <div className="ct_creative_single_img">
                <img alt="AI app builder" className="ct_object_cover ct_border_radius_10" loading="lazy" src="/img/telecome_img_new_4.webp" />
              </div>
            </div>
          </div>
          <div className="row align-items-center ct_py_70 pb-0">
            <div className="col-md-4 mb-5 mb-md-0 aos-init aos-animate">
              <div className="ct_creative_single_img">
                <img alt="AI app builder" loading="lazy" src="/img/telecome_img_new_5.webp" />
              </div>
            </div>
            <div className="col-md-7 mb-5 mb-md-0 aos-init aos-animate offset-md-1">
              <div className="ct_flexible_serivce_cnt">
          ...
          <div className="row">
            <div className="col-md-12">
              <h2 className="ct_fs_44 ct_fw_700 text-center mb-5">
                Why Creative AI Makes Modern  <span className="ct_orange_gredient_text"> Telecom Solutions Simple
                </span>
              </h2>
      ...
      <section className="ct_pt_50 ct_pb_50">
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <h2 className="ct_fs_44 ct_fw_700 text-center">Modern Telecom Experiences Powered <br />
          ...
          <div className="col-md-12">
            <div className="ct_free_demo_bg">
              ...
              <div className="text-center mt-4">
                <a className="ct_blue_btn_fill ct_white_btn" href={LOGIN_URL}>Turn Ideas Into Reality
                </a>
              </div>
            </div>
          </div>
