...
import {
  ...
  restaurantFAQItems,
} from "@/utils/data/Restaurantpagedata";
  ...
  return (
    <>
      ...
      <IndustryHero
        ...
        description="Build a professional restaurant website with AI and manage online ordering, reservations, menus, customers, and staff from one platform. No coding required."
        image="/img/restaurant-banner.webp"
      />

      <FeatureCardsGrid
        title="Everything Your Restaurant Needs in One Platform"
        description="Build a professional restaurant website, manage online orders, reservations, and customers from one AI-powered platform."
      ...
      <BlogsSection blogs={blogs} apiUrl={API_URL} />
