          ...
          <div className="row pt-4 align-items-center">
            ...
            <div className="col-md-5 mb-4 mb-md-0 offset-md-1">
              <div className="ct_how_works_img">
                <img alt="AI-powered app and web development" loading="lazy" src="/img/how-works_right.webp" />
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="col-md-7 mb-5 mb-md-0 aos-init aos-animate offset-md-1">
              <div className="ct_flexible_serivce_cnt">
                ...
                <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">
                  Creative AI understands your business requirements from simple input and converts them into a clear project structure. Using an AI app builder, it analyzes features automatically so enterprises don’t need deep technical explanations.
          ...
          <div className="row align-items-center ct_py_70 pb-0 ct_row_reverse_767">
            <div className="col-md-7 mb-5 mb-md-0 aos-init aos-animate">
              <div className="ct_flexible_serivce_cnt">
                ...
                <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">
                  With an AI app builder, enterprises can turn ideas into real applications quickly. It reduces manual development work and helps teams launch projects in much less time.
          ...
          <div className="row align-items-center ct_py_70 pb-0">
            ...
            <div className="col-md-7 mb-5 mb-md-0 aos-init aos-animate offset-md-1">
              <div className="ct_flexible_serivce_cnt">
                ...
                <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">
                  Creative AI provides complete support from planning and design to development and deployment. With the help of an AI app builder, enterprises also get assistance for custom requirements and final launch whenever needed.
