    ...
    <>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "BreadcrumbList",
            "@id": "https://creativethoughts.ai/photography-website-builder#breadcrumb",
            "itemListElement": [
              {
                "@type": "ListItem",
                "position": 1,
              ...
              },
              {
                ...
                "item": "https://creativethoughts.ai/photography-website-builder"
              }
            ]
          })
        }}
...
<script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "WebPage",
            "@id": "https://creativethoughts.ai/photography-website-builder#webpage",
            "url": "https://creativethoughts.ai/photography-website-builder",
            "name": "Photography Website Builder | Creative AI",
            "description": "Build a professional photography website with portfolio galleries, online booking, photography services, client galleries, inquiries, and business management tools using Creative AI.",
            "isPartOf": {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "FAQPage",
            "mainEntity": photographyFAQItems.map((item) => ({
              "@type": "Question",
