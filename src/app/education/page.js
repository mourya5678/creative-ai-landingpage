    ...
    <>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <h2 className="ct_fw_700 ct_fs_44 text-center mb-3">How Creative AI Delivers Faster  <br />
                <span className="ct_orange_gredient_text"> Education Solutions</span>
              </h2>
          ...
          <div className="row align-items-center ct_py_70 pb-0 ct_row_reverse_767">
            ...
            <div className="col-md-4 mb-5 mb-md-0 offset-md-1 aos-init aos-animate">
              <div className="ct_creative_single_img">
                <img alt="AI app builder for mobile and web" className="ct_object_cover ct_border_radius_10" loading="lazy" src="/img/eudcation_img_new_2.webp" />
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-md-12">
              <h2 className="ct_fs_44 ct_fw_700 text-center">
                Why Creative AI Delivers Better <br />
                <span className="ct_orange_gredient_text">  Learning Experiences</span>
              </h2>
              <div className="owl-carousel owl-theme ct_dot_nav_hover pt-5" id="ct_retaial_app_slider">
                <div className="item">
      ...
      <section className="ct_pt_50 ct_pb_50">
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <h2 className="ct_fs_44 ct_fw_700 text-center"> Modern Education Experiences Built <br />
                <span className="ct_orange_gredient_text"> by Creative AI</span> </h2>
            </div>
          </div>
          <div className="owl-carousel owl-theme ct_pricing_works ct_dot_nav_hover pt-5">
            <div className="item">
              <div className="row align-items-center pb-0">
                <div className="col-md-8 mb-4 mb-md-0 aos-init aos-animate">
                  <div className="ct_flexible_serivce_cnt">
                    ...
                    <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">
                      ...
                      serving learners in India, to prepare for the PTE Academic Exam. It
                      offers 98% accurate AI mock tests, plus audio and text practice with
                      instant feedback to improve reading and speaking skills. Built with
                      Angular JS, Node JS, and MySQL on AWS, it ensures a smooth, modern
                      learning experience.
                    </p>
                  </div>
                </div>
                <div className="col-md-4 mb-4 mb-md-0 aos-init aos-animate">
                  <div className="ct_creative_single_img">
                    <img alt="AI app builder for mobile and web" className="ct_border_radius_10 ct_object_cover" loading="lazy" src="/img/web_PTE_master_new_123.webp" />
                  </div>
                </div>
              </div>
              <div className="mt-5">
                    ...
                    <div className="ct_compare_table ct_some_feature_detail_box">
                      <details className="">
                        <summary className="d-flex align-items-center gap-2 position-relative">
                          ...
                          <h5 className="mb-0 ct_fs_18 ct_fw_600">AI-Powered Mock Tests
                            with 98.7% Accuracy
                          </h5>
                    ...
                    <div className="ct_compare_table ct_some_feature_detail_box">
                      <details className="">
                        <summary className="d-flex align-items-center gap-2 position-relative">
                          ...
                          <h5 className="mb-0 ct_fs_18 ct_fw_600">Audio &amp; Text Practice
                            with Instant Error Highlighting</h5>
                          <div className="ct_compare_collapse_icon">
                            <svg fill="none" height="12" viewBox="0 0 14 12" width="14" xmlns="http://www.w3.org/2000/svg">
                              <path d="M1.68506 8.573L6.71006 3.54847C6.77592 3.48252 6.86529 3.44546 6.9585 3.44546C7.0517 3.44546 7.14108 3.48252 7.20693 3.54847L12.2319 8.573" stroke="#3C3E49" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
                            </svg>
                    ...
                    <div className="ct_compare_table ct_some_feature_detail_box">
                      <details className="">
                        <summary className="d-flex align-items-center gap-2 position-relative">
                          ...
                          <h5 className="mb-0 ct_fs_18 ct_fw_600">Smart Progress Tracking
                            Dashboard</h5>
                          <div className="ct_compare_collapse_icon">
                            <svg fill="none" height="12" viewBox="0 0 14 12" width="14" xmlns="http://www.w3.org/2000/svg">
                              <path d="M1.68506 8.573L6.71006 3.54847C6.77592 3.48252 6.86529 3.44546 6.9585 3.44546C7.0517 3.44546 7.14108 3.48252 7.20693 3.54847L12.2319 8.573" stroke="#3C3E49" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
                        ...
                        <p className="mb-0 mt-3">A user-friendly dashboard lets students track
                          scores, monitor progress, and focus on areas that need
                          improvement. </p>
                      </details>
                    </div>
                  </div>
            ...
            <div className="item">
              <div className="row align-items-center pb-0">
                <div className="col-md-8 mb-4 mb-md-0 aos-init aos-animate">
                  <div className="ct_flexible_serivce_cnt">
                    <h4 className="ct_fs_26 ct_fw_700 mb-3 ct_line_h_25">Language Academy
                    </h4>
                    <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">
                      Language Academy is an advanced education platform designed to help
                      students prepare for PTE, NAATI, and IELTS exams with flexible online
                      and offline learning options. Built with Angular JS (frontend), Node JS
                      (backend), MySQL (database), and hosted on AWS, the platform delivers
                      reliable performance and a seamless learning experience.
                    </p>
                  </div>
                </div>
                <div className="col-md-4 mb-4 mb-md-0 aos-init aos-animate">
                  <div className="ct_creative_single_img">
                    <img alt="AI app builder for mobile and web" loading="lazy" src="/img/ecommerse_section_img.webp" />
                  </div>
                </div>
              </div>
              <div className="mt-5">
                    ...
                    <div className="ct_compare_table ct_some_feature_detail_box">
                      <details className="">
                        <summary className="d-flex align-items-center gap-2 position-relative">
                          ...
                          <h5 className="mb-0 ct_fs_18 ct_fw_600">Expert Video &amp; Audio
                            Lessons</h5>
                          <div className="ct_compare_collapse_icon">
                            <svg fill="none" height="12" viewBox="0 0 14 12" width="14" xmlns="http://www.w3.org/2000/svg">
                              <path d="M1.68506 8.573L6.71006 3.54847C6.77592 3.48252 6.86529 3.44546 6.9585 3.44546C7.0517 3.44546 7.14108 3.48252 7.20693 3.54847L12.2319 8.573" stroke="#3C3E49" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
                        ...
                        <p className="mb-0 mt-3"> Students can learn anytime with high-quality
                          video tutorials, audio practice materials, and clear
                          explanations from experienced teachers.</p>
                      </details>
                    </div>
                  </div>
                  <div className="col-md-4 mb-4 mb-md-0">
                    <div className="ct_compare_table ct_some_feature_detail_box">
                      <details className="">
                        <summary className="d-flex align-items-center gap-2 position-relative">
                          ...
                          <h5 className="mb-0 ct_fs_18 ct_fw_600">Online Books &amp; Practice
                            Tests</h5>
                          <div className="ct_compare_collapse_icon">
                            <svg fill="none" height="12" viewBox="0 0 14 12" width="14" xmlns="http://www.w3.org/2000/svg">
                              <path d="M1.68506 8.573L6.71006 3.54847C6.77592 3.48252 6.86529 3.44546 6.9585 3.44546C7.0517 3.44546 7.14108 3.48252 7.20693 3.54847L12.2319 8.573" stroke="#3C3E49" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
                        ...
                        <p className="mb-0 mt-3">
                          Access a wide range of online study materials, mock tests,
                          and e-books to practice and improve exam skills at your own
                          pace.
                        </p>
                      </details>
                    </div>
                    ...
                    <div className="ct_compare_table ct_some_feature_detail_box">
                      <details className="">
                        <summary className="d-flex align-items-center gap-2 position-relative">
                          ...
                          <h5 className="mb-0 ct_fs_18 ct_fw_600">Flexible Offline &amp;
                            Classroom Support</h5>
                          <div className="ct_compare_collapse_icon">
                            <svg fill="none" height="12" viewBox="0 0 14 12" width="14" xmlns="http://www.w3.org/2000/svg">
                              <path d="M1.68506 8.573L6.71006 3.54847C6.77592 3.48252 6.86529 3.44546 6.9585 3.44546C7.0517 3.44546 7.14108 3.48252 7.20693 3.54847L12.2319 8.573" stroke="#3C3E49" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
                            </svg>
                        ...
                        <p className="mb-0 mt-3"> In addition to online learning, Language
                          Academy offers in-person classes and support for students
                          who prefer face-to-face preparation </p>
                      </details>
                    </div>
                  </div>
                </div>
