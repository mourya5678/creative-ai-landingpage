...
export const metadata = {
  title: "About Creative AI | AI Website & App Builder",
  description: "Learn about Creative AI, an AI-powered platform for building websites, apps, portals, and business software without coding.",
