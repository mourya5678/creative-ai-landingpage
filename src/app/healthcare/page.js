              ...
              <div className="col-lg-6 mb-4 mb-lg-0">
                <div className="ct_hero_banner_left_cnt">
                  ...
                  <div className="ct_btn_group mt-5">
                    <a className="ct_blue_btn_fill" href={LOGIN_URL}>Launch Faster with AI</a>
                  </div>
                </div>
              </div>
              <div className="col-lg-6 mb-4 mb-lg-0">
          ...
          <div className="row">
            <div className="col-md-12">
              ...
              <p className="ct_fw_18 text-center mb-2 ct_fw_500 mx-auto" style={{ maxWidth: "750px" }}>
                Launch secure and scalable healthcare solutions faster with our no-code AI app builder and complete end-to-end development support.
            ...
            <div className="col-md-7 mb-5 mb-md-0 aos-init aos-animate offset-md-1">
              <div className="ct_flexible_serivce_cnt">
                ...
                <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">
                  Simply submit your requirements, and our no-code AI app builder understands your idea to create a healthcare solution based on your needs.
          ...
          <div className="row align-items-center ct_py_70 pb-0 ct_row_reverse_767">
            <div className="col-md-7 mb-5 mb-md-0 aos-init aos-animate">
              <div className="ct_flexible_serivce_cnt">
                ...
                <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">
                  From appointment booking to telemedicine features, the no-code AI app builder helps speed up development without long technical processes.
                </p>
              </div>
            </div>
          ...
          <div className="row align-items-center ct_py_70 pb-0">
            ...
            <div className="col-md-7 mb-5 mb-md-0 aos-init aos-animate offset-md-1">
              <div className="ct_flexible_serivce_cnt">
                ...
                <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">Create different project variations, improve workflows, and customize features to match your healthcare business goals.
          ...
          <div className="row align-items-center ct_py_70 pb-0 ct_row_reverse_767">
            <div className="col-md-7 mb-5 mb-md-0 aos-init aos-animate">
              <div className="ct_flexible_serivce_cnt">
                ...
                <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">
                  Need advanced features or changes? Connect directly with our team to discuss requirements and get a tailored healthcare solution.
          ...
          <div className="row align-items-center ct_py_70 pb-0">
            ...
            <div className="col-md-7 mb-5 mb-md-0 aos-init aos-animate offset-md-1">
              <div className="ct_flexible_serivce_cnt">
                ...
                <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">
                  From planning and design to development and deployment, our no-code AI app builder supports every stage of your healthcare app journey.
                ...
                <div className="item">
                  <div className="ct_retail_app_card_12">
                    <figure>
                      ...
                      <figcaption>
                        <h3 className="ct_fs_22 ct_fw_700 text-center">  Faster Healthcare App Development

                        </h3>
                        <p className="mb-0 ct_fs_18 ct_line_h_25 text-center">
                          Our no-code AI app builder helps healthcare businesses create and launch apps quickly without long development cycles.
                        </p>
                      </figcaption>
                    </figure>
                  </div>
                  ...
                  <div className="ct_retail_app_card_12">
                    <figure>
                      ...
                      <figcaption>
                        ...
                        <p className="mb-0 ct_fs_18 ct_line_h_25 text-center">
                          We handle everything from planning and design to development and deployment, making the process simple and stress-free.
                ...
                <div className="item">
                  <div className="ct_retail_app_card_12">
                    <figure>
                      ...
                      <figcaption>
                        <h3 className="ct_fs_22 ct_fw_700 text-center"> Flexible and Custom Solutions


                        </h3>
                        <p className="mb-0 ct_fs_18 ct_line_h_25 text-center"> Healthcare businesses can create multiple project variations, customize features, and get expert support for advanced requirements.
            ...
            <div className="item">
              <div className="row align-items-center pb-0">
                <div className="col-md-8 mb-4 mb-md-0 aos-init aos-animate">
                  <div className="ct_flexible_serivce_cnt">
                    <h4 className="ct_fs_26 ct_fw_700 mb-3 ct_line_h_25">HealthSteer | UK
                    </h4>
                    <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">
                      HealthSteer is a comprehensive digital healthcare platform that connects patients,
                      doctors, insurers, and clinics through secure, compliant online consultations and smart
                      clinic management tools.
                    </p>
                    <br />
                    <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">
                      With HealthSteer, patients can instantly book GP and specialist consultations online,
                      while healthcare providers benefit from purpose-built software that supports digital
                      transformation, secure communication, and streamlined operations all fully compliant
                      with CQC and ICO standards.
                    </p>
                  </div>
                </div>
                    ...
                    <div className="ct_compare_table ct_some_feature_detail_box">
                      <details className="">
                        <summary className="d-flex align-items-center gap-2 position-relative">
                          ...
                          <h5 className="mb-0 ct_fs_18 ct_fw_600">Instant Online Consultations</h5>
                        ...
                        <p className="mb-0 mt-3">Easy access to trusted GPs and specialists for patients,
                          anytime.</p>
                      </details>
                    </div>
                  </div>
                    ...
                    <div className="ct_compare_table ct_some_feature_detail_box">
                      <details className="">
                        <summary className="d-flex align-items-center gap-2 position-relative">
                          ...
                          <h5 className="mb-0 ct_fs_18 ct_fw_600">Smart Clinic Software</h5>
                          <div className="ct_compare_collapse_icon">
                            <svg fill="none" height="12" viewBox="0 0 14 12" width="14" xmlns="http://www.w3.org/2000/svg">
                              <path d="M1.68506 8.573L6.71006 3.54847C6.77592 3.48252 6.86529 3.44546 6.9585 3.44546C7.0517 3.44546 7.14108 3.48252 7.20693 3.54847L12.2319 8.573" stroke="#3C3E49" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
                            </svg>
                        ...
                        <p className="mb-0 mt-3">
                          Powerful tools for doctors, insurers, and hospitals to manage processes, reduce
                          costs, and tackle medical inflation.
                        </p>
                      </details>
                    </div>
                  </div>
                    ...
                    <div className="ct_compare_table ct_some_feature_detail_box">
                      <details className="">
                        <summary className="d-flex align-items-center gap-2 position-relative">
                          ...
                          <h5 className="mb-0 ct_fs_18 ct_fw_600">Secure &amp; Compliant</h5>
                          <div className="ct_compare_collapse_icon">
                            <svg fill="none" height="12" viewBox="0 0 14 12" width="14" xmlns="http://www.w3.org/2000/svg">
                              <path d="M1.68506 8.573L6.71006 3.54847C6.77592 3.48252 6.86529 3.44546 6.9585 3.44546C7.0517 3.44546 7.14108 3.48252 7.20693 3.54847L12.2319 8.573" stroke="#3C3E49" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
                            </svg>
                        ...
                        <p className="mb-0 mt-3">Built with strict healthcare regulations in mind no
                          shortcuts, only robust, purpose-driven features.</p>
                      </details>
                    </div>
                  </div>
                </div>
