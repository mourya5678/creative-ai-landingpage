    ...
    <>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "BreadcrumbList",
            "@id": "https://creativethoughts.ai/law-firm-website-builder#breadcrumb",
            "itemListElement": [
              {
                "@type": "ListItem",
                "position": 1,
              ...
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "Law Firm Website Builder",
                "item": "https://creativethoughts.ai/law-firm-website-builder"
              }
            ]
          })
        }}
...
<script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "WebPage",
            "@id": "https://creativethoughts.ai/law-firm-website-builder#webpage",
            "url": "https://creativethoughts.ai/law-firm-website-builder",
            "name": "Law Firm Website Builder | Creative AI",
            "description": "Build a professional law firm website with consultation booking, client portals, case management, document management, payments, and legal business tools using Creative AI.",
            "isPartOf": {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "FAQPage",
            "mainEntity": lawFirmFAQItems.map((item) => ({
              "@type": "Question",
