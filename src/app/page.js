...
export default function Page() {
  return (
    <>
      <HomeInit />
      <Header localClass="et_main_header_344" />
              ...
              <div className="ct_sticky_scroll_main">
                <section className="cti_saas_card">
                  ...
                  <div className="ct_sass_card_img">
                    <img
                      src="/img/build-sass-product-img.webp"
                      className="img-fluid"
                ...
                <section className="cti_saas_card is_sky">
                  ...
                  <div className="ct_sass_card_img">
                    <img
                      src="/img/professional-websites-img.webp"
                ...
                <section className="cti_saas_card is_green">
                  ...
                  <div className="ct_sass_card_img">
                    <img
                      src="/img/launch-marketplace-img.webp"
