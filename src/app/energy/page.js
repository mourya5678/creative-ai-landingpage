              ...
              <div className="col-lg-6 mb-4 mb-lg-0">
                <div className="ct_hero_banner_left_cnt">
                  ...
                  <div className="ct_btn_group mt-5">
                    <a className="ct_blue_btn_fill" href={process.env.NEXT_PUBLIC_LOGIN_URL || "http://72.60.203.98/login"}>Get Started with AI</a>
                  </div>
                </div>
              </div>
              <div className="col-lg-6 mb-4 mb-lg-0">
        ...
        <div className="container">
          ...
          <div className="row align-items-center ct_py_70 pb-0 ct_row_reverse_767">
            ...
            <div className="col-md-4 mb-5 mb-md-0 offset-md-1 aos-init aos-animate">
              <div className="ct_creative_single_img">
                <img alt="AI app builder for mobile and web" loading="lazy" src="/img/energy_solutions_new_img_2.webp" />
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-md-12">
              <h1 className="ct_fs_44 ct_fw_700 text-center mb-5">
                Why Energy Businesses Choose<span className="ct_orange_gredient_text">  Creative AI</span>
              </h1>
                    ...
                    <figure>
                      ...
                      <figcaption>
                        <h4 className="ct_fs_22 ct_fw_700 text-center">
                          Flexible and Custom Energy Workflows
                        </h4>
                        <p className="mb-0 ct_fs_18 ct_line_h_25 text-center">
          ...
          <div className="col-md-12">
            <div className="ct_free_demo_bg">
              ...
              <div className="text-center mt-4">
                <a className="ct_blue_btn_fill ct_white_btn" href={process.env.NEXT_PUBLIC_LOGIN_URL || "http://72.60.203.98/login"}>Start Building Now
                </a>
              </div>
            </div>
          </div>
