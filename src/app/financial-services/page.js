    ...
    <>
              ...
              <div className="col-lg-6 mb-4 mb-lg-0">
                <div className="ct_hero_banner_left_cnt">
                  ...
                  <div className="ct_btn_group mt-5">
                    <a className="ct_blue_btn_fill" href="http://72.60.203.98/login">Build Now</a>
                  </div>
                </div>
              </div>
              <div className="col-lg-6 mb-4 mb-lg-0">
          ...
          <div className="row">
            <div className="col-md-12">
              ...
              <p className="ct_fw_18 text-center mb-2 ct_fw_500">
                With Creative AI, you can build and launch secure fintech apps faster without any coding, with full support at every stage.
            ...
            <div className="col-md-7 mb-5 mb-md-0 aos-init aos-animate offset-md-1">
              <div className="ct_flexible_serivce_cnt">
                ...
                <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">
                  Creative AI allows fintech companies and financial service providers to create secure applications without technical complexity. You can turn your idea into a working financial product quickly and safely.
          ...
          <div className="row align-items-center ct_py_70 pb-0 ct_row_reverse_767">
            <div className="col-md-7 mb-5 mb-md-0 aos-init aos-animate">
              <div className="ct_flexible_serivce_cnt">
                ...
                <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">
                  It speeds up the entire process from planning to launch. Financial apps that usually take months can be built and deployed in much less time.
            ...
            <div className="col-md-7 mb-5 mb-md-0 aos-init aos-animate offset-md-1">
              <div className="ct_flexible_serivce_cnt">
                <h4 className="ct_fs_26 ct_fw_700 mb-3 ct_line_h_25">
                  Custom features for financial services


                </h4>
                <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">
                  You can add features like user accounts, transactions, dashboards, and reporting based on your business needs. Everything is flexible and customizable.
          ...
          <div className="row align-items-center ct_py_70 pb-0 ct_row_reverse_767">
            <div className="col-md-7 mb-5 mb-md-0 aos-init aos-animate">
              <div className="ct_flexible_serivce_cnt">
                ...
                <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">
                  Creative AI helps automate key processes like data handling, user management, and financial operations, reducing manual work and improving accuracy.
          ...
          <div className="row align-items-center ct_py_70 pb-0">
            ...
            <div className="col-md-7 mb-5 mb-md-0 aos-init aos-animate offset-md-1">
              <div className="ct_flexible_serivce_cnt">
                ...
                <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">
                  From idea to live product, you get full support. The platform also ensures your financial app can scale as your business grows.
      ...
      <section className="ct_latest_project_bg ct_olw_nav_show_main">
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <h1 className="ct_fs_44 ct_fw_700 text-center mb-5">
                Why<span className="ct_orange_gredient_text"> Financial Businesses</span> Choose Us
                ...
                <div className="item">
                  <div className="ct_retail_app_card_12">
                    <figure>
                      ...
                      <figcaption>
                        <h4 className="ct_fs_22 ct_fw_700 text-center"> Secure and reliable solutions

                        </h4>
                        <p className="mb-0 ct_fs_18 ct_line_h_25 text-center">
                          We help financial businesses build secure apps with strong data protection and reliable performance.
                        </p>
                      </figcaption>
                    </figure>
                  </div>
                ...
                <div className="item">
                  <div className="ct_retail_app_card_12">
                    <figure>
                      ...
                      <figcaption>
                        <h4 className="ct_fs_22 ct_fw_700 text-center">Fast and no-code development
                        </h4>
                        <p className="mb-0 ct_fs_18 ct_line_h_25 text-center">
                          Create fintech applications quickly without coding, significantly reducing development time.
                ...
                <div className="item">
                  <div className="ct_retail_app_card_12">
                    <figure>
                      ...
                      <figcaption>
                        <h4 className="ct_fs_22 ct_fw_700 text-center"> End-to-end support

                        </h4>
                        <p className="mb-0 ct_fs_18 ct_line_h_25 text-center">
                          From planning to launch, we provide complete support to ensure your financial product runs smoothly.
            ...
            <div className="item">
              <div className="row align-items-center pb-0">
                <div className="col-md-8 mb-4 mb-md-0 aos-init aos-animate">
                  <div className="ct_flexible_serivce_cnt">
                    ...
                    <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">
                      ...
                      Canadian users who want full control of their money. Users can securely
                      link all their personal financial details income, loans, payments, and
                ...
                <div className="col-md-4 mb-4 mb-md-0 aos-init aos-animate">
                  <div className="ct_creative_single_img">
                    <img alt="AI app builder for mobile and web" loading="lazy" src="/img/Financial_Solutions_new_16.webp" />
                  </div>
                </div>
              </div>
              <div className="mt-5">
                    ...
                    <div className="ct_compare_table ct_some_feature_detail_box">
                      <details className="">
                        <summary className="d-flex align-items-center gap-2 position-relative">
                          ...
                          <h5 className="mb-0 ct_fs_18 ct_fw_600">Unified Financial
                            Dashboard</h5>
                        ...
                        <p className="mb-0 mt-3">Track income, loans, and savings in one
                          secure place.
                        </p>
                      </details>
                    </div>
                    ...
                    <div className="ct_compare_table ct_some_feature_detail_box">
                      <details className="">
                        <summary className="d-flex align-items-center gap-2 position-relative">
                          ...
                          <h5 className="mb-0 ct_fs_18 ct_fw_600"> Personalized Smart
                            Suggestions</h5>
                          <div className="ct_compare_collapse_icon">
                            <svg fill="none" height="12" viewBox="0 0 14 12" width="14" xmlns="http://www.w3.org/2000/svg">
                              <path d="M1.68506 8.573L6.71006 3.54847C6.77592 3.48252 6.86529 3.44546 6.9585 3.44546C7.0517 3.44546 7.14108 3.48252 7.20693 3.54847L12.2319 8.573" stroke="#3C3E49" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
                    ...
                    <div className="ct_compare_table ct_some_feature_detail_box">
                      <details className="">
                        <summary className="d-flex align-items-center gap-2 position-relative">
                          ...
                          <h5 className="mb-0 ct_fs_18 ct_fw_600">Robust Data Privacy</h5>
                          <div className="ct_compare_collapse_icon">
                            <svg fill="none" height="12" viewBox="0 0 14 12" width="14" xmlns="http://www.w3.org/2000/svg">
                              <path d="M1.68506 8.573L6.71006 3.54847C6.77592 3.48252 6.86529 3.44546 6.9585 3.44546C7.0517 3.44546 7.14108 3.48252 7.20693 3.54847L12.2319 8.573" stroke="#3C3E49" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
                            </svg>
                        ...
                        <p className="mb-0 mt-3">Top-level security ensures sensitive
                          financial details stay protected.
                        </p>
                      </details>
                    </div>
                  </div>
          ...
          <div className="col-md-12">
            <div className="ct_free_demo_bg">
              <h2 className="ct_fs_28 text-center text-white ct_fw_700 mb-2 mx-auto" style={{ maxWidth: "600px" }}>
                Create secure and smart finance apps in minutes with AI.

              </h2>
              <div className="text-center mt-4">
                <a className="ct_blue_btn_fill ct_white_btn" href="http://72.60.203.98/login">Build Now</a>
              </div>
            </div>
          </div>
        </div>
