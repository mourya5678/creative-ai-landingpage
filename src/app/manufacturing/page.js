    ...
    <>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <h2 className="ct_fw_700 ct_fs_44 text-center mb-3">How Creative AI Transforms Manufacturing  <br />
                <span className="ct_orange_gredient_text">Ideas into Apps</span>
              </h2>
              <p className="ct_fw_18 text-center mb-2 ct_fw_500 mx-auto" style={{ maxWidth: "680px" }}>
                Turn manufacturing ideas into scalable digital solutions with our no-code AI app builder and end-to-end development support.
            ...
            <div className="col-md-7 mb-5 mb-md-0 aos-init aos-animate offset-md-1">
              <div className="ct_flexible_serivce_cnt">
                ...
                <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">
                  Our no-code AI app builder understands your requirements and turns manufacturing ideas into functional digital solutions.
          ...
          <div className="row align-items-center ct_py_70 pb-0 ct_row_reverse_767">
            <div className="col-md-7 mb-5 mb-md-0 aos-init aos-animate">
              <div className="ct_flexible_serivce_cnt">
                ...
                <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">
                  Build apps for production tracking, inventory management, workflow automation, and team coordination with ease.
            ...
            <div className="col-md-4 mb-5 mb-md-0 offset-md-1 aos-init aos-animate">
              <div className="ct_creative_single_img">
                <img alt="AI app builder" loading="lazy" src="/img/menufecture_img__new_2.webp" />
              </div>
            </div>
          </div>
          <div className="row align-items-center ct_py_70 pb-0">
            ...
            <div className="col-md-7 mb-5 mb-md-0 aos-init aos-animate offset-md-1">
              <div className="ct_flexible_serivce_cnt">
                ...
                <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">
                  The no-code AI app builder reduces development time, helping manufacturing businesses launch apps faster.
          ...
          <div className="row align-items-center ct_py_70 pb-0 ct_row_reverse_767">
            <div className="col-md-7 mb-5 mb-md-0 aos-init aos-animate">
              <div className="ct_flexible_serivce_cnt">
                ...
                <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">
                  Create multiple project variations, optimize workflows, and customize features for your manufacturing operations.
          ...
          <div className="row align-items-center ct_py_70 pb-0">
            ...
            <div className="col-md-7 mb-5 mb-md-0 aos-init aos-animate offset-md-1">
              <div className="ct_flexible_serivce_cnt">
                ...
                <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">
                  From planning and design to development and deployment, Creative AI supports every stage of your manufacturing project.
          ...
          <div className="row">
            <div className="col-md-12">
              <h2 className="ct_fs_44 ct_fw_700 text-center mb-5">
                Why <span className="ct_orange_gredient_text">Manufacturing Businesses</span> Choose Us
              </h2>
                ...
                <div className="item">
                  <div className="ct_retail_app_card_12">
                    <figure>
                      ...
                      <figcaption>
                        <h3 className="ct_fs_22 ct_fw_700 text-center">Build Manufacturing Apps Faster

                        </h3>
                        <p className="mb-0 ct_fs_18 ct_line_h_25 text-center">
                          Our no-code AI app builder simplifies development and helps businesses launch manufacturing solutions quickly.
                ...
                <div className="item">
                  <div className="ct_retail_app_card_12">
                    <figure>
                      ...
                      <figcaption>
                        <h3 className="ct_fs_22 ct_fw_700 text-center">Flexible Solutions for Manufacturing Needs
                        </h3>
                        <p className="mb-0 ct_fs_18 ct_line_h_25 text-center">
                          Create custom apps for workflow automation, inventory management, production monitoring, and more.
                ...
                <div className="item">
                  <div className="ct_retail_app_card_12">
                    <figure>
                      ...
                      <figcaption>
                        <h3 className="ct_fs_22 ct_fw_700 text-center">Complete End-to-End Support

                        </h3>
                        <p className="mb-0 ct_fs_18 ct_line_h_25 text-center">
                          We support every stage of development, including planning, design, development, and deployment.
      ...
      <section className="ct_pt_50 ct_pb_50">
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <h2 className="ct_fs_44 ct_fw_700 text-center">Real Manufacturing Apps
                <span className="ct_orange_gredient_text"> We’ve Built</span></h2>
            </div>
          </div>
          <div className="owl-carousel owl-theme ct_pricing_works ct_dot_nav_hover pt-4">
            <div className="item">
              <div className="row align-items-center pb-0">
                <div className="col-md-8 mb-4 mb-md-0 aos-init aos-animate">
                  <div className="ct_flexible_serivce_cnt">
                    <h4 className="ct_fs_26 ct_fw_700 mb-3 ct_line_h_25">SBM
                    </h4>
                    <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">
                      SBM is a dedicated eCommerce platform designed to connect vendors, multi-vendors, and
                      end users for the buying and selling of safety equipment. Tailored specifically for UE
                      (Urban Enterprise) users, SBM simplifies the process of sourcing safety products through
                      verified vendors and supports bulk order requests. The platform is built with Vue JS for
                      the frontend, Laravel for the backend, PostgreSQL for secure data handling, and hosted
                      on AWS, with clean UI designs made in Figma.
                    </p>
                  </div>
                </div>
                <div className="col-md-4 mb-4 mb-md-0 aos-init aos-animate">
                  <div className="ct_creative_single_img">
                    <img alt="AI-powered app and web development" className="ct_object_cover ct_border_radius_10" loading="lazy" src="/img/web_sbm_new_12.webp" />
                  </div>
                </div>
              </div>
              <div className="mt-5">
                    ...
                    <div className="ct_compare_table ct_some_feature_detail_box">
                      <details className="">
                        <summary className="d-flex align-items-center gap-2 position-relative">
                          ...
                          <h5 className="mb-0 ct_fs_18 ct_fw_600">Multi-Vendor Marketplace</h5>
                        ...
                        <p className="mb-0 mt-3">Enables multiple vendors to list and sell certified safety
                          equipment, expanding choices for buyers.</p>
                      </details>
                    </div>
                  </div>
                  <div className="col-md-4 mb-4 mb-md-0">
                    <div className="ct_compare_table ct_some_feature_detail_box">
                      <details className="">
                        <summary className="d-flex align-items-center gap-2 position-relative">
                          ...
                          <h5 className="mb-0 ct_fs_18 ct_fw_600">Bulk Orders &amp; B2B Deals</h5>
                          <div className="ct_compare_collapse_icon">
                            <svg fill="none" height="12" viewBox="0 0 14 12" width="14" xmlns="http://www.w3.org/2000/svg">
                              <path d="M1.68506 8.573L6.71006 3.54847C6.77592 3.48252 6.86529 3.44546 6.9585 3.44546C7.0517 3.44546 7.14108 3.48252 7.20693 3.54847L12.2319 8.573" stroke="#3C3E49" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
                            </svg>
                        ...
                        <p className="mb-0 mt-3">
                          Users can easily apply for bulk product requests, get special pricing, and
                    ...
                    <div className="ct_compare_table ct_some_feature_detail_box">
                      <details className="">
                        <summary className="d-flex align-items-center gap-2 position-relative">
                          ...
                          <h5 className="mb-0 ct_fs_18 ct_fw_600">Integrated Communication Tools</h5>
                          <div className="ct_compare_collapse_icon">
                            <svg fill="none" height="12" viewBox="0 0 14 12" width="14" xmlns="http://www.w3.org/2000/svg">
                              <path d="M1.68506 8.573L6.71006 3.54847C6.77592 3.48252 6.86529 3.44546 6.9585 3.44546C7.0517 3.44546 7.14108 3.48252 7.20693 3.54847L12.2319 8.573" stroke="#3C3E49" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
                            </svg>
                        ...
                        <p className="mb-0 mt-3">Built-in call and chat features let users connect directly with
                          sellers for quick queries, custom orders, or after-sales support.</p>
                      </details>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-md-8 mb-4 mb-md-0 aos-init aos-animate">
                  <div className="ct_flexible_serivce_cnt">
                    ...
                    <p className="mb-0 ct_fs_16 ct_fw_600 ct_line_h_25">
                      ...
                      center connectivity. We design advanced optical fibers, cables, and software with a
                      strong focus on innovation and sustainability. Our global expertise helps telcos and
                      enterprises build future-ready digital networks.
                    </p>
                  </div>
                </div>
                <div className="col-md-4 mb-4 mb-md-0 aos-init aos-animate">
                    ...
                    <div className="ct_compare_table ct_some_feature_detail_box">
                      <details className="">
                        <summary className="d-flex align-items-center gap-2 position-relative">
                          ...
                          <h5 className="mb-0 ct_fs_18 ct_fw_600">Complete Optical &amp; Digital Solutions</h5>
                          <div className="ct_compare_collapse_icon">
                            <svg fill="none" height="12" viewBox="0 0 14 12" width="14" xmlns="http://www.w3.org/2000/svg">
                              <path d="M1.68506 8.573L6.71006 3.54847C6.77592 3.48252 6.86529 3.44546 6.9585 3.44546C7.0517 3.44546 7.14108 3.48252 7.20693 3.54847L12.2319 8.573" stroke="#3C3E49" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
                            </svg>
                        ...
                        <p className="mb-0 mt-3">Explore a full range of products and services for 5G, FTTH,
                          data centers, and enterprise networks.</p>
                      </details>
                    </div>
                  </div>
                  <div className="col-md-4 mb-4 mb-md-0">
                    <div className="ct_compare_table ct_some_feature_detail_box">
                      <details className="">
                        <summary className="d-flex align-items-center gap-2 position-relative">
                          ...
                          <h5 className="mb-0 ct_fs_18 ct_fw_600">Innovation &amp; Sustainability Focus</h5>
                          <div className="ct_compare_collapse_icon">
                            <svg fill="none" height="12" viewBox="0 0 14 12" width="14" xmlns="http://www.w3.org/2000/svg">
                              <path d="M1.68506 8.573L6.71006 3.54847C6.77592 3.48252 6.86529 3.44546 6.9585 3.44546C7.0517 3.44546 7.14108 3.48252 7.20693 3.54847L12.2319 8.573" stroke="#3C3E49" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
                            </svg>
                        ...
                        <p className="mb-0 mt-3">
                          Showcases STL’s advanced R&amp;D, patents, and commitment to green manufacturing and
                          Net Zero goals.
                        </p>
                      </details>
                    </div>
                    ...
                    <div className="ct_compare_table ct_some_feature_detail_box">
                      <details className="">
                        <summary className="d-flex align-items-center gap-2 position-relative">
                          ...
                          <h5 className="mb-0 ct_fs_18 ct_fw_600">Global Presence &amp; Insights</h5>
                          <div className="ct_compare_collapse_icon">
                            <svg fill="none" height="12" viewBox="0 0 14 12" width="14" xmlns="http://www.w3.org/2000/svg">
                              <path d="M1.68506 8.573L6.71006 3.54847C6.77592 3.48252 6.86529 3.44546 6.9585 3.44546C7.0517 3.44546 7.14108 3.48252 7.20693 3.54847L12.2319 8.573" stroke="#3C3E49" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
                            </svg>
                        ...
                        <p className="mb-0 mt-3">Provides detailed case studies, global project highlights, and
                          industry insights for customers worldwide.</p>
                      </details>
                    </div>
                  </div>
                </div>
